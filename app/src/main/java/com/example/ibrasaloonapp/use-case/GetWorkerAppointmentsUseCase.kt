...
import com.example.ibrasaloonapp.presentation.ui.worker_appointments.AppointmentFilter
...
class GetWorkerAppointmentsUseCase
@Inject
constructor(
    ...
    suspend operator fun invoke(
        ...
        flow {
            ...
            val result = appointmentsRepository.getWorkerAppointments(
                search = search,
                startTime = startDate,
                endTime = endDate,
                status = status,
